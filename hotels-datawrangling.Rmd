...
How many bookings involve at least 1 child **or** baby? 9,322.
...
# surprising that there are 403 children traveling alone
```
...
```{r freq_table_cancelled_bookings}
hotels %>% 
...
city hotels. Which type of hotel is higher, on average? City.
...
hotels %>% 
  ...
  select(hotel, adr, arrival_date_month, arrival_date_year, people)
